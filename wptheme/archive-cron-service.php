...
$service_archive_title = esc_html__('Service Archive', 'cron');
if(isset($cron_fn_option['service_archive_title'])){
	$service_archive_title = $cron_fn_option['service_archive_title'];
}
?>
			...
			<div class="cron_fn_pagetitle">
				<div class="container">
					<div class="title_holder">
						<h3>
							<?php echo esc_html($service_archive_title);?>
						</h3>
