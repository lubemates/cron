...
if(!isset($cron_fn_pagestyle) && $cron_fn_pagestyle){
	$cron_fn_pagestyle 			= 'full';
}
...
{
if(isset($cron_fn_option['blog_single_title'])){
	$pageTitle = $cron_fn_option['blog_single_title'];
}else{
	$pageTitle = esc_html__('Our Blog', 'cron');
}
?>
		...
		<div class="cron_fn_pagetitle index_page">
			<div class="container">
				<div class="title_holder">
					<h3><?php echo esc_html($pageTitle);?></h3>
				</div>
			</div>
		</div>
		<!-- /PAGE TITLE -->
